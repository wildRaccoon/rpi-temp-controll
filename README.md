...
Програма для Raspberry Pi, яка контролює систему опалення з твердопаливним котлом та термоакумулятором. Зчитує температури з кількох датчиків та автоматично керує розумною розеткою Sonoff з прошивкою Tasmota для включення теплого підлоги з метою безпеки та ефективного використання тепла.

## 📋 Функціонал

- Зчитування температури з 4 датчиків (3x DS18B20 + 1x MAX31855)
- Автоматичне керування розеткою Sonoff з прошивкою Tasmota (теплий підлога)
...
├── controllers/           # Контролери (Sonoff, температура)
...
- `sonoff` - налаштування розетки Sonoff з прошивкою Tasmota
