...
## ⚙️ Крок 4: Налаштування конфігурації
...
## 🚀 Крок 6: Налаштування як systemd сервіс
...
## 🛠️ Крок 8: Налаштування firewall (опціонально)
...
## 📊 Крок 9: Моніторинг та обслуговування
...
### Розетка Tapo не підключається

1. Перевірте IP адресу та мережеве підключення
2. Перевірте email та пароль в config.yaml
3. Перевірте, чи розетка доступна:
   ```bash
   ping 192.168.1.100
   ```
